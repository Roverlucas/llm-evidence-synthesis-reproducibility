...
Raw agreement & 75.0\% & --- \\
PABAK, 3-class / binary & 0.500 / 0.558 & --- \\
...
\textbf{The disagreement is directional, not diffuse.} The binary discordant cells are 2 versus 19 (exact McNemar $p=2.2\times10^{-4}$), and marginal homogeneity is rejected on the 3-class table (Stuart--Maxwell $\chi^2(2)=15.4$, $p=4.6\times10^{-4}$; Bowker symmetry likewise rejected). Rater~2 returned 49 INCLUDE decisions against rater~1's 30. Systematic directional divergence of this kind indicates that the two raters applied different readings of the written protocol, which is a defect of the instrument rather than noise in the raters.
...
Because $t$-percentiles inflate as $k{\to}2$ and $q^{\ast}{\geq}1/\sum w_i^{\ast}$ under heterogeneity, HKSJ produces substantially wider CIs in small literatures.
